...
import { Search, Plus, Clock, AlertCircle, CheckCircle2, Loader2, FileText } from 'lucide-react'
import { AppShell, PageContent } from '@/components/layout/AppShell'
import { Button, Spinner, EmptyState, Skeleton } from '@/components/shared/ui'
...
export default function InvestigationsPage() {
  ...
  const investigations: AiInvestigation[] = data ?? []
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">AI-generated deep dives into alerts</p>
              </div>
            </div>
