...
const NAV_MAIN: NavItem[] = [
  ...
  { label: 'User Risk',           href: '/risk/users',            icon: BarChart3 },
  { label: 'Asset Risk',          href: '/risk/assets',           icon: Activity },
  { label: 'Vulnerabilities',     href: '/risk/vulnerabilities',  icon: ShieldCheck },
  { label: 'Reports',             href: '/reports',               icon: BookOpen },
  { label: 'Incident Timeline',   href: '/incidents/timeline',    icon: FileSearch },
  { label: 'Compliance Posture',  href: '/compliance-posture',    icon: Shield },
