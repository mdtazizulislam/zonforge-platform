...
const outputDir = path.resolve('proof/runs/serial-hotfix-cust-route-01-local')
...
await page.waitForFunction(() => window.location.pathname === '/customer-dashboard', { timeout: 120000 })
...
await page.waitForFunction(() => window.location.pathname === '/dashboard', { timeout: 120000 })
