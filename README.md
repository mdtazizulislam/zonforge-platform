...
- Screenshots and capture notes: [docs/demo/screenshots/README.md](docs/demo/screenshots/README.md)
- Architecture visuals: [docs/demo/architecture/README.md](docs/demo/architecture/README.md)

### Visual Demo

Dashboard local surface (real capture):

![ZonForge Dashboard Home](docs/demo/screenshots/dashboard-home.png)

Gateway health and API visibility (real capture):

![ZonForge Dashboard Health](docs/demo/screenshots/dashboard-health.png)

Service runtime proof (real capture from live runtime output):

![ZonForge Services Running](docs/demo/screenshots/services-running.png)

Required-path health proof (real capture from live health command output):

![ZonForge Health Check Proof](docs/demo/screenshots/health-check-proof.png)

AI module readiness proof (real capture from running AI service endpoint):

![ZonForge AI Module Proof](docs/demo/screenshots/ai-intelligence-or-module-proof.png)
